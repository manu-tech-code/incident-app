    ...
    @endif
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10" >
            ...
            <div class="flex gap-5 flex-wrap">
                ...
                @endif
                @if(Auth::user()->role === 3)
                    <x-card-component  class="!bg-amber-500 border-amber-500" title="User Setup" description="description" route="incidents.index">
                        <svg class="w-7 h-7 fill-white" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
