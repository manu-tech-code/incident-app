...
{{--       </form>--}}
    ...
    <div class="py-12 px-3 @if(Auth::user()->role === 1) float-right w-[calc(100%-15rem)] @endif">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    @foreach ($incidents as $index => $incident)
                        ...
                        <tr class="{{ $rowClass }} border-b text-black">
                            ...
                            <td class="px-1 py-2 capitalize">{{ $incident->it_personnel_id ?\App\Models\User::whereId($incident->it_personnel_id)->value('name'): 'Not Assigned' }}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
