<x-app-layout>
    <div class="px-3 py-12 @if(Auth::user()->role === 1) float-right w-[calc(100%-15rem)] @endif">
      @if(Auth::user()->role === 1)
      ...
      @endif
        ...
        <!-- Create Post modal -->
        <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden bg-slate-300 bg-opacity-70 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
