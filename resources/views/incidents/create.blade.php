<x-app-layout>
    ...
    <div class="py-12" style="background-image: url('../../assets/img/bg.jpg')">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('incidents.store') }}">
                ...
                <div class="mt-4">
                    <x-input-label for="caller" :value="__('Caller')" />
                    <x-text-input id="caller" class="block mt-1 w-full" type="text" name="caller" :value="old('caller')" required />
                    <x-input-error :messages="$errors->get('caller')" class="mt-2" />
                </div>
