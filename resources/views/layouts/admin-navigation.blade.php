<nav x-data="{ open: false }" class="py-10 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    <div class="mx-auto px-4">
        <div class="h-fit space-y-10">
            <div class="w-48 flex flex-col items-center justify-center space-y-5">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="dark:fill-gray-300 text-3xl">
